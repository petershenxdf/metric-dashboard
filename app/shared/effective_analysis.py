...
This is pure logic with no Flask dependency — it lives in `app.shared` so both
workflow pages and module-level code can import it without layering violations.
"""
