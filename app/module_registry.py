...
WORKFLOWS: Tuple[WorkflowInfo, ...] = (
    ...
    WorkflowInfo(
        ...
        step="7",
        debug_focus="chat UI receives current selection and label context without choosing a refinement path",
        status="working",
    ...
    WorkflowInfo(
        ...
        group="Feedback Pipeline",
        step="8",
        debug_focus="chatbox forwards messages to IntentInstructionProvider; structured instruction state is visible next to chat history before Path A or Path B routing",
        status="working",
    ...
    WorkflowInfo(
        ...
        purpose="Inspect visually grounded chat intent validation with the shared scatterplot, selection, labeling, and intent runtime state.",
        modules=("chatbox", "intent-instruction", "selection", "labeling", "scatterplot"),
        group="Feedback Pipeline",
        step="8.5",
        debug_focus="shared grounding context plus embedded scatterplot audit before Step 9 constraint conversion",
        status="working",
