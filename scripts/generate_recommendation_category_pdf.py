...
SOURCE = ROOT / "docs" / "recommendation_categories_guide_zh.md"
OUTPUT = ROOT / "docs" / "recommendation_categories_guide_zh.pdf"
FONT_PATHS = (
...
class PdfWriter:
    ...
    def _footer(self) -> None:
        self.fig.text(
            0.5,
            0.035,
            f"Rule-Grounded Recommendation Categories · page {self.page_no}",
            ha="center",
            va="bottom",
            fontsize=8.2,
            color="#6b7280",
